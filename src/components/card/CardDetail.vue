  ...
  >
    <div class="bg-gray2 w-cardDetail h-5/6 p-8 grid grid-cols-8 gap-x-2 overflow-scroll" data-cy="card-detail">
        ...
        <div class="ml-9 mb-4">
          ...
          <div class="inline-block mt-2">
            ...
            <h2 class="inline-block px-4 py-1 rounded-sm font-light text-gray-800 bg-gray3 hover:bg-gray5 cursor-default">
              ...
              <div v-show="overdue(state.activeCard) && !state.activeCard.completed" class="text-sm bg-red-500 inline-block text-white px-2 mx-1 rounded-sm">
                OVERDUE
              </div>
      ...
      <div class="col-span-2 grid content-start gap-y-2">
        ...
        <div class="bg-gray3 px-2 py-0.5 text-sm rounded-sm text-gray-600 cursor-pointer hover:bg-gray5" data-cy="calendar-button" @click="showDate = true">
